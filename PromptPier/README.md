# PromptPier — Legal Pages

Static legal documents for the **PromptPier** Chrome extension.
...
| `privacy-policy.zh-CN.html` | 隐私政策（中文） |
| `terms-of-service.html` | Terms of Service (English) |
| `terms-of-service.zh-CN.html` | 服务条款（中文） |
| `index.html` | Index / links hub |
